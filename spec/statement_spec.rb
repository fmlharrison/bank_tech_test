...
describe Statement do
  ...
  let(:first_statement) { double :first_statement, :bank_statement => [{date: "10/01/2012", credit: 1000.00, debit: " ", balance: 1000.00}] }
  ...
  it 'hold the users bank statment' do
    expect(first_statement.bank_statement).to eq [{date: "10/01/2012", credit: 1000.00, debit: " ", balance: 1000.00}]
  end
  ...
  context "#new_deposit" do
    ...
    it 'should add a record of a new deposit to the bank statement' do
      statement.new_deposit("10/01/2012", 1000, 1000)
      expect(statement.bank_statement).to eq ([{date: "10/01/2012", credit: "1000.00", debit: " ", balance: "1000.00"}])
    end
  ...
  context "#new_withdrawal" do
    ...
    it 'should add a record of a new withdrawal to the bank statement' do
      ...
      expect(statement.bank_statement).to eq ([{date: "13/01/2012", credit: " ", debit: "500.00", balance: "500.00"}, {date: "10/01/2012", credit: "1000.00", debit: " ", balance: "1000.00"}])
    end
